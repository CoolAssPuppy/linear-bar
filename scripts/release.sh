#!/bin/bash
#
# One-shot release automation for Linear Bar.
#
...
#
# Example:
#   ./scripts/release.sh 2.0.0 "<li>Redesigned UI.</li><li>Bug fixes.</li>"
...
APP_FOLDER="linear-bar"
DUB_SHORTLINK="https://coolasspuppy.com/linear-bar-updates"
...
APP_ZIP="$EXPORT_DIR/LinearBar.app.zip"
...
DMG="$DIST/LinearBar-$VERSION.dmg"
SPARKLE_TXT="$DIST/LinearBar-$VERSION.sparkle.txt"
...
# 8. Upload DMG to R2
#----------------------------------------------------------------------
DMG_NAME="LinearBar-$VERSION.dmg"
...
# Also upload as LinearBar-latest.dmg so the strategic-nerds site has a stable URL
R2_LATEST_KEY="apps/$APP_FOLDER/LinearBar-latest.dmg"
...
echo ""
echo "============================================================"
echo "Released Linear Bar $VERSION (build $NEW_BUILD)"
echo ""
